...
class MonopolyLogic:
    ...
    BOARD_DATA = [
        ...
        ("An Giang", "$60", "#8B4513", 60, 3, 2,10,30,90,160,250),
        ("Mũi Né", "", "#FFFFFF", 0, 0, 0,0,0,0,0,0),
        ("Đồng Tháp", "$60", "#8B4513", 60, 3, 4,20,60,180,320,450),
        ("Income\nTax", "Pay $200", "#FFFFFF", 0, 0, 0,0,0,0,0,0),
        ("Phú Quốc", "$200", "#FFFFFF", 200, 1, 0,0,0,0,0,0),
        ("Vĩnh Long", "$100", "#87CEEB", 100, 4, 6,30,90,270,400,550),
        ("Chance", "", "#FFFFFF", 0, 0, 0,0,0,0,0,0),
        ("Cần Thơ", "$100", "#87CEEB", 100, 4, 6,30,90,270,400,550),
        ("Tây Ninh", "$120", "#87CEEB", 120, 4, 8,40,100,300,450,600),
        ("Thanh Hóa\n(JAIL)", "", "#FFFFFF", 0, 0, 0,0,0,0,0,0),
        ("Đồng Nai", "$140", "#D02090", 140, 5, 10,50,150,450,625,750),
        ("Sầm Sơn", "$150", "#FFFFFF", 150, 2, 0,0,0,0,0,0),
        ("Đắk Lắk", "$140", "#D02090", 140, 5, 10,50,150,450,625,750),
        ("Lâm Đồng", "$160", "#D02090", 160, 5, 12,60,180,500,700,900),
        ("Côn Đảo", "$200", "#FFFFFF", 200, 1, 0,0,0,0,0,0),
        ("Khánh Hòa", "$180", "#FFA500", 180, 6, 14,70,200,550,750,950),
        ("Chest", "", "#FFFFFF", 0, 0, 0,0,0,0,0,0),
        ("Gia Lai", "$180", "#FFA500", 180, 6, 14,70,200,550,750,950),
        ("Đà Nẵng", "$200", "#FFA500", 200, 6, 16,80,220,600,800,1000),
        ("Nam\nĐịnh", "", "#FFFFFF", 0, 0, 0,0,0,0,0,0),
        ("Quảng Trị", "$220", "#FF0000", 220, 7, 18,90,250,700,875,1050),
        ("Chance", "", "#FFFFFF", 0, 0, 0,0,0,0,0,0),
        ("Ninh Bình", "$220", "#FF0000", 220, 7, 18,90,250,700,875,1050),
        ("Hải Phòng", "$240", "#FF0000", 240, 7, 20,100,300,750,925,1100),
        ("Nha Trang", "$200", "#FFFFFF", 200, 1, 0,0,0,0,0,0),
        ("Hưng Yên", "$260", "#FFFF00", 260, 8, 22,110,330,800,975,1150),
        ("Bắc Ninh", "$260", "#FFFF00", 260, 8, 22,110,330,800,975,1150),
        ("Water\nWorks", "$150", "#FFFFFF", 150, 2, 0,0,0,0,0,0),
        ("Phú Thọ", "$280", "#FFFF00", 280, 8, 24,120,360,850,1025,1200),
        ("Ăn nem\nChua", "", "#FFFFFF", 0, 0, 0,0,0,0,0,0),
        ("Thái Nguyên", "$300", "#008000", 300, 9, 26,130,390,900,1100,1275),
        ("Lào Cai", "$300", "#008000", 300, 9, 26,130,390,900,1100,1275),
        ("Chest", "", "#FFFFFF", 0, 0, 0,0,0,0,0,0),
        ("Hà Nội", "$320", "#008000", 320, 9, 28,150,450,1000,1200,1400),
        ("Mỹ Khê", "$200", "#FFFFFF", 200, 1, 0,0,0,0,0,0),
        ("Chance", "", "#FFFFFF", 0, 0, 0,0,0,0,0,0),
        ("HCM", "$350", "#0000FF", 350, 10, 35,175,500,1100,1300,1500),
        ("Luxury\nTax", "Pay $100", "#FFFFFF", 0, 0, 0,0,0,0,0,0),
        ("Quảng Ngãi", "$400", "#0000FF", 400, 10, 50,200,600,1400,1700,2000),
    ]
